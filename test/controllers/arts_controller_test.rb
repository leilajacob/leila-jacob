...
class ArtsControllerTest < ActionController::TestCase
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post :create, art: { category_id: @art.category_id, description: @art.description, name: @art.name, price: @art.price, quantity: @art.quantity }
    end
  ...
  test "should update art" do
    patch :update, id: @art, art: { category_id: @art.category_id, description: @art.description, name: @art.name, price: @art.price, quantity: @art.quantity }
    assert_redirected_to art_path(assigns(:art))
  end
